...
//    }
    ...
    public function meFacade(Request $request)
    {
        ...
        $targetCompanyId = $companiesResponse['companies'][config('services.freee-accounting.default_company_id')]['id'];
    ...
    public function meMacro(Request $request)
    {
        ...
        $company_id = $user->freee()->getCompanyId(config('services.freee-accounting.default_company_id'));
